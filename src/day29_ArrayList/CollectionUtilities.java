...
public class CollectionUtilities {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(list);           // sorts elements from smaller to bigger
        ...
        Collections.swap(list3, 0, 5);
        System.out.println(list3);

        System.out.println("-----------------------------------");

        int max = Collections.max(list3);         // returns max of ArrayList
        int min = Collections.min(list3);         // returns min of ArrayList
