...
*/
        ...
        int count = 0;
        for (Integer eachScore : students.values()) {       // solving by the value
            if (eachScore >= 95) {
                count++;
            }
        }
...
/*
        for (String eachKey : students.keySet()) {          // solving by the key
            Integer eachScore = students.get(eachKey);      // getting the value from each element of map
            if(eachScore >= 95){
                count++;
            }
        }
*/
        ...
        for (
                Map.Entry<String, Integer> entry : students.entrySet()) {
