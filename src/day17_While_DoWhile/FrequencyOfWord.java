...
public class FrequencyOfWord {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <= str.length() - 4; i++) {                    // limits the length of str accordingly with searched word length not to give out of index error
            String eachSub = str.substring(i, i + 4);                   // creates new substrings from main str
