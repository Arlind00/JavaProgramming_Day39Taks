...
public class CapitalOne {
    ...
    public static void main(String[] args) {
        ...
        Employee[] employees = {employee1, employee2, employee3, employee4, employee5};     // add all employees to array

        int countFullTime = 0;
        int countPartTime = 0;
        double max = employees[0].salary;               // we assume first employee has bigest salary
        double min = employees[0].salary;               // we assume first employee has smallest salary
        ...
        for (Employee employee : employees) {
            ...
            if (employee.salary > max){             // to find biggest salary among employees
                max = employee.salary;
            }

            if (employee.salary < min){             // to find smallest salary among employees
                min = employee.salary;
            }
        }
