...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        MyFirstFunctionalInterface somethingSomething;
        somethingSomething = number -> {
            if (number % 2 == 0) {
                System.out.println(number + " something is even");
            } else {
                System.out.println(number + " something is odd");
            }
        };
        somethingSomething.apply(25);
    }
