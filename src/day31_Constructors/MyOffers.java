...
public class MyOffers {
    ...
    public static void main(String[] args) {
        ...
        Offer[] myOffers = {offer1, offer2, offer3, offer4, offer5};                        // add all offers to array


        ArrayList<Offer> fullTimeOffers = new ArrayList<>( Arrays.asList( myOffers )  );    // convert array into ArrayList
